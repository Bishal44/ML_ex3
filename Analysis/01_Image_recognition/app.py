...
modelPath = "models/saved_model.pb"
...
def run_detector(detector, path):
    ...
    # save inference times in csv
    with open('inferences.csv', 'a') as file:
        writer = csv.writer(file)
    ...
    # added return statement for bounding boxes for output
    return result["detection_boxes"].tolist()
...
def main():
    ...
    data_output = request.values.get('output')
    ...
    if data_input.find(".") != -1:
        ...
        for filename in os.listdir(data_input):
            ...
            print("  " + filename)
    # run_detector needs to return the bounding boxes of the images
    output = run_detector(detector, data_input)
